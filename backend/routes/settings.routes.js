...
router.put('/debt-templates/:templateId', settingsController.updateDebtTemplate);
router.delete('/debt-templates/:templateId', settingsController.deleteDebtTemplate);
